...
def print_banner():
    """Print the P0rtFinder banner with credits."""
...
def main(target, ports_range, protocol, nse_scripts=None, verbose=False):
    ...
    print(f"P0rtFinder - Scanning Target: {target} ({target_ip})")
...
if __name__ == "__main__":
    try:
        parser = argparse.ArgumentParser(description="P0rtFinder - Advanced Port Scanner with NSE integration")
